...
Shader "Flag"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( sin( ( ( _Speed * floor( mulTime4 ) ) + ( v.texcoord.xy.x * _Freq ) ) ) * float3(0,0.5,1) * _Strength * v.texcoord.xy.x );
		}
...
/*ASEBEGIN
Version=15900
178;577;1906;599;1141.613;180.2158;1.63209;True;False
...
Node;AmplifyShaderEditor.SinOpNode;14;68.45911,757.754;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;108.97,756.651;Float;False;Property;_Strength;Strength;3;0;Create;True;0;0;False;0;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;64.81313,-207.2382;Float;False;Property;_Emissive;Emissive;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1;-72.42175,-351.7595;Float;False;Property;_Color;Color;1;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NormalVertexDataNode;9;90.45111,979.4005;Float;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=21EF7CBBC1B5F89F1F824046EFB76C8C1209601E