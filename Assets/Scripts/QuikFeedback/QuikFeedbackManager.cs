...
namespace Pataya.QuikFeedback
{
    ...
    public class QuikFeedbackManager : MonoBehaviour
    {
        ...
        private GamepadRumbler rumbler;
        ...
        private void CheckForComponents()
        {
            ...
            if (rumbler == null)
            {
                GamepadRumbler r = GetComponent<GamepadRumbler>();
                if (r != null) rumbler = r;
                else
                {
                    GamepadRumbler newR = gameObject.AddComponent<GamepadRumbler>();
                    rumbler = newR;
                }
            }
        }
        ...
        public void Rumble(RumbleFeedback rumble)
        {
            rumbler.Rumble(rumble);
        }
